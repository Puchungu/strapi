...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estatus: Schema.Attribute.Enumeration<['pending', 'paid', 'failed']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    stripeSessionId: Schema.Attribute.Text;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Variantes: Schema.Attribute.Component<'inventario.variante', true>;
  };
}
